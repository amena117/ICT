        ...
        >
            ...
            <div className="p-6 flex flex-col flex-grow">
                <div className="flex items-center gap-2 mb-3">
                    <span className="px-3 py-1 text-xs font-semibold tracking-wider text-white bg-gradient-to-r from-primary to-primary-light rounded-full shadow-sm">
                        {resource.type}
                    </span>
                </div>
                ...
                <Link
                    ...
                    className="inline-flex items-center justify-center w-full px-4 py-2 text-sm font-semibold text-primary border-2 border-primary rounded-lg hover:bg-primary hover:text-white transition-colors duration-300 mt-auto"
                >
                    Read Article
                </Link>
            </div>
